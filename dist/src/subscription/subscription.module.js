...
const subscription_cron_service_1 = require("./subscription-cron.service");
...
exports.SubscriptionModule = SubscriptionModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [subscription_controller_1.SubscriptionController, subscription_plan_controller_1.SubscriptionPlanController],
        providers: [
